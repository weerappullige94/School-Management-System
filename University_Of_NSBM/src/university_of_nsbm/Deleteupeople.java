...
public class Deleteupeople extends javax.swing.JFrame {
    DBOperation dbops = new DBOperation();
    Uregistration_form urf2;
    
    public Deleteupeople() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deleteupeople.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deleteupeople().setVisible(true);
            }
        });
    }
