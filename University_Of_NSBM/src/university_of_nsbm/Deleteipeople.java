...
public class Deleteipeople extends javax.swing.JFrame {

    DBOperation4 dbop4 = new DBOperation4();
    Iregistration_form irf2;
    
    public Deleteipeople() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deleteipeople.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deleteipeople().setVisible(true);
            }
        });
    }
