...
public class updatelcourse extends javax.swing.JFrame {
    DBOperation7 dbop7 = new DBOperation7();
    
    public updatelcourse() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        LC_registration_form lcrf1 = new LC_registration_form();
        
        lcrf1.setRegID(new Integer(textRegID.getText()).intValue());
        lcrf1.setFullName(textFullname.getText());
        lcrf1.setSubject(textSubject.getText());
        lcrf1.setCode(textCode.getText());
        lcrf1.setYear(textYear.getSelectedItem().toString());
        lcrf1.setSemester(textSemester.getSelectedItem().toString());
        lcrf1.setFacalty(textFacalty.getSelectedItem().toString());
        lcrf1.setDate(textDate.getText());
        lcrf1.setTime(textTime.getText());
        lcrf1.setVenue(textVenue.getText());

        
        if(dbop7.updatelcourse(lcrf1)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updatelcourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updatelcourse().setVisible(true);
            }
        });
    }
