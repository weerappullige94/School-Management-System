...
public class Deleteppeople extends javax.swing.JFrame {

    DBOperation2 dbop2 = new DBOperation2();
    Pregistration_form prf2;
    
    public Deleteppeople() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deleteppeople.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deleteppeople().setVisible(true);
            }
        });
    }
