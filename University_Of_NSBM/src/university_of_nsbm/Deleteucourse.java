...
public class Deleteucourse extends javax.swing.JFrame {
    DBOperation5 dbop5 = new DBOperation5();
    UC_registration_form ucrf2;
    
    public Deleteucourse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deleteucourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deleteucourse().setVisible(true);
            }
        });
    }
