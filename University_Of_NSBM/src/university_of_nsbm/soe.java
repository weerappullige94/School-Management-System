...
public class soe extends javax.swing.JFrame {
    ...
    private void y1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_y1ActionPerformed
              // go to the school of engineering undergraduate year 1 course details page
              soe1st s_o_e1 = new soe1st();
              s_o_e1.setVisible(true);
              s_o_e1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void y2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_y2ActionPerformed
               //go to the school of computing undergraduate year 2 course details page
               soe2nd s_o_e2 = new soe2nd();
               s_o_e2.setVisible(true);
               s_o_e2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void y3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_y3ActionPerformed
              //go to the school of engineering undergraduate year 3 course details page
              soe3rd s_o_e3 = new soe3rd();
              s_o_e3.setVisible(true);
              s_o_e3.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void y4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_y4ActionPerformed
                // go to the school of engineering undergraduate year 4 course details page
                soe4th s_o_e4 = new soe4th();
                s_o_e4.setVisible(true);
                s_o_e4.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
