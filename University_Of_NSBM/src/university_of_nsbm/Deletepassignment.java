...
public class Deletepassignment extends javax.swing.JFrame {
    DBOperation10 dbop10 = new DBOperation10();
    P_Assignment_details pad2;
    
    public Deletepassignment() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(dbop10.deletepassignment(pad2)){
            JOptionPane.showMessageDialog(this,"Successfully Deleted!");//say successfully inserted
            this.dispose();
            return;
        }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deletepassignment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deletepassignment().setVisible(true);
            }
        });
    }
