...
public class Deleteuassignment extends javax.swing.JFrame {
    
    DBOperation9 dbop9 = new DBOperation9();
    U_Assignment_details uad2;
    
    public Deleteuassignment() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(dbop9.deleteuassignment(uad2)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deleteuassignment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deleteuassignment().setVisible(true);
            }
        });
    }
