...
public class sob extends javax.swing.JFrame {
    ...
    private void y1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_y1ActionPerformed
             // go to the school of business undergraduate year 1 course details page
             sob1st s_o_b1 = new sob1st();
             s_o_b1.setVisible(true);
             s_o_b1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void y2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_y2ActionPerformed
             // go to the school of business undergraduate year 2 course details page
             sob2nd s_o_b2 = new sob2nd();
             s_o_b2.setVisible(true);
             s_o_b2.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void y3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_y3ActionPerformed
               // go to the school of business undergraduate year 3 course details page
               sob3rd s_o_b3 = new sob3rd();
               s_o_b3.setVisible(true);
               s_o_b3.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    ...
    private void y4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_y4ActionPerformed
       // go to the school of business undergraduate year 4 course details page
       sob4th s_o_b4 = new sob4th();
       s_o_b4.setVisible(true);
       s_o_b4.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
