...
public class Deleteicourse extends javax.swing.JFrame {

    DBOperation8 dbop8 = new DBOperation8();
    IC_registration_form icrf2;
    
    public Deleteicourse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Deleteicourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Deleteicourse().setVisible(true);
            }
        });
    }
