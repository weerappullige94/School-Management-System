...
public class updateicourse extends javax.swing.JFrame {
    DBOperation8 dbop8 = new DBOperation8();
    
    public updateicourse() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        IC_registration_form icrf1 = new IC_registration_form();

        icrf1.setRegID(new Integer(icrf1.getRegID()).intValue());
        icrf1.setFullName(textFullname.getText());
        icrf1.setSubject(textSubject.getText());
        icrf1.setCode(textCode.getText());
        icrf1.setYear(textYear.getSelectedItem().toString());
        icrf1.setSemester(textSemester.getSelectedItem().toString());
        icrf1.setFacalty(textFacalty.getSelectedItem().toString());
        icrf1.setDate(textDate2.getText());
        icrf1.setTime(textTime.getText());
        icrf1.setVenue(textvenue.getSelectedItem().toString());

        
        if(dbop8.updateicourse(icrf1)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updateicourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updateicourse().setVisible(true);
            }
        });
    }
